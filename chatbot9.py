...
def main():
    ...
    if HF_AVAILABLE:
        print("\n🤖 Hello! I'm an empathic chatbot powered by advanced emotion detection.")
        print("   I can detect multiple emotions in your messages simultaneously!")
    else:
        print("\n🤖 Hello! I'm an empathic chatbot using keyword-based emotion detection.")
    ...
    while True:
        try:
            ...
            print(f"\n🔍 Primary: {emotion} ({emotion_data['confidence']:.1%}) [{model_used}]")
